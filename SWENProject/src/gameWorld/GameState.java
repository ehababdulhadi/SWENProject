...
public class GameState {
    ...
    private Player player = new Player("Player", new ArrayList<Drawable>(), null, null );
...
//		Drawable box = new Drawable("Box", "You need a 4 digit pin to open this box!", ROOMS[0], tempImage);
//		box.setIsBox(true); // Declaring this Drawable as a box that contains other items //
//		Drawable bronzeKey = new Drawable ("Bronze Key", "Bronze Key!", ROOMS[0], tempImage);
//		box.getBoxItems().add(bronzeKey);
//		box.boxSetLocked(true); // Lock the box! //
//		// Create the silver Key and Note //
//		Drawable silverKey = new Drawable("Silver Key", "Silver Key!", ROOMS[0], tempImage);
//		silverKey.setHidden(true);
//		Drawable noteOfRoom1 = new Drawable("note1", "Tell the Game Story to Player", ROOMS[0], tempImage);
//		// Add all items to Room 1 //
//		ROOMS[0].getItemsOfTheRoom().addAll(items);
//		
//		// Fill Room 2 //
//		Drawable gun = new Drawable("Gun", "A Gun! Could be used to kill avarage sized zombies!", ROOMS[1], tempImage);
//		
//		// Fill Room 3 //
//		Drawable room1BoxCodeNumber = new Drawable("Code of Box in Room 1", "1234!",  ROOMS[2], tempImage);
//		Zombie room3Zombie = new Zombie("Room3 Zombie", ROOMS[2], tempImage);
//		room3Zombie.setItemCarriedByZombie(room1BoxCodeNumber);
//		
//		// Fill Room 4 //
//		Drawable silverKeyNote = new Drawable("Silver Key Note", "Silver Key is Hidden in Room 1 behind the brick!", ROOMS[3], tempImage);
//		Zombie room4Zombie = new Zombie("Room4 Zombie", ROOMS[3], tempImage);
//		room4Zombie.setItemCarriedByZombie(silverKeyNote);
//		
//		// Fill Room 5 //
//		Drawable goldenKey = new Drawable("Golden Key", "Golden Key!", ROOMS[4], tempImage);
//		Zombie room5Zombie = new Zombie("Room5 Zombie", ROOMS[4], tempImage);
//		room5Zombie.setItemCarriedByZombie(goldenKey);
//		
//		// Fill Room 6 //
//		Drawable bazooka = new Drawable("Bazooka", "Bazooka!!", ROOMS[5], tempImage);
